...
const Dashboard: React.FC = () => {
  return (
    <div className="bg-secondary dark:bg-dmbg rounded-xl mx-4 h-full w-full"> 
      
    <div className="bg-secondary dark:bg-dms rounded-xl mx-4 h-full w-full shadow-inner  py-10">
